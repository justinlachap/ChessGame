...
void Fou::calculerMouvements(Echiquier e_)
{
	...
	{
		if ((e_.cases[positionsRangeeVersLaDroite + uneCase][positionsRangeeVersLeHaut + uneCase] == caseVide))
			mouvementsDisponibles_.push_back(std::pair(positionsRangeeVersLaDroite + uneCase, positionsRangeeVersLeHaut + uneCase));

		else if ((e_.cases[positionsRangeeVersLaDroite + uneCase][positionsRangeeVersLeHaut + uneCase]->obtenirCouleur() == estBlanc_))
			break;
	...
	{
		if ((e_.cases[positionsRangeeVersLaGauche - uneCase][positionsRangeeVersLeHaut + uneCase] == caseVide))
			mouvementsDisponibles_.push_back(std::pair(positionsRangeeVersLaGauche - uneCase, positionsRangeeVersLeHaut + uneCase));

		else if ((e_.cases[positionsRangeeVersLaGauche - uneCase][positionsRangeeVersLeHaut + uneCase]->obtenirCouleur() == estBlanc_))
			break;
	...
	{
		if ((e_.cases[positionsRangeeVersLaGauche - uneCase][positionsRangeeVersLeBas - uneCase] == caseVide))
			mouvementsDisponibles_.push_back(std::pair(positionsRangeeVersLaGauche - uneCase, positionsRangeeVersLeBas - uneCase));

		else if ((e_.cases[positionsRangeeVersLaGauche - uneCase][positionsRangeeVersLeBas - uneCase]->obtenirCouleur() == estBlanc_))
			break;
	...
	{
		if ((e_.cases[positionsRangeeVersLaDroite + uneCase][positionsRangeeVersLeBas - uneCase] == caseVide))
			mouvementsDisponibles_.push_back(std::pair(positionsRangeeVersLaDroite + uneCase, positionsRangeeVersLeBas - uneCase));

		else if ((e_.cases[positionsRangeeVersLaDroite + uneCase][positionsRangeeVersLeBas - uneCase]->obtenirCouleur() == estBlanc_))
			break;
