...
void Tour::calculerMouvements(Echiquier e_)
{
	...
	{
		if (e_.cases[positionsRangeeVersLaDroite + uneCase][position_.second] != caseVide)
		{
			if (e_.cases[positionsRangeeVersLaDroite + uneCase][position_.second]->obtenirCouleur() != estBlanc_)
	...
	{
		if (e_.cases[positionsRangeeVersLaGauche - uneCase][position_.second] != caseVide)
		{
			if (e_.cases[positionsRangeeVersLaGauche - uneCase][position_.second]->obtenirCouleur() != estBlanc_)
	...
	{
		if (e_.cases[position_.first][positionsRangeeVersLeHaut + uneCase] != caseVide)
		{
			if (e_.cases[position_.first][positionsRangeeVersLeHaut + uneCase]->obtenirCouleur() != estBlanc_)
	...
	{
		if (e_.cases[position_.first][positionsRangeeVersLeBas - uneCase] != caseVide)
		{
			if (e_.cases[position_.first][positionsRangeeVersLeBas - uneCase]->obtenirCouleur() != estBlanc_)
